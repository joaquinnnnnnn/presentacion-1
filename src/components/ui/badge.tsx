...
const badgeVariants = cva('inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors', { variants: { variant: { outline: 'text-foreground' } }, defaultVariants: { variant:'outline' } });
